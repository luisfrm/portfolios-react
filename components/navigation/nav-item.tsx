...
const NAVIGATION_STYLES = {
  ...
  colors:
    "text-gray-900 dark:text-gray-300 hover:border-gray-300 hover:text-gray-500 dark:hover:text-white",
};

export function NavItem({ children, url, className, onClick }: NavItemProps) {
