...
export const PDF_URLS = {
  en: "https://drive.google.com/file/d/1OUK_vJieKiYb9ZRVlBksZwVAhgAU2r9v/view?usp=sharing",
  es: "https://drive.google.com/file/d/1z6Qk6MLHX2ekxokBYDe-36Hm2tGOTsf_/view?usp=sharing"
} as const;
...
export const HERO_STYLES = {
  ...
  ctaButton: 'inline-flex items-center px-8 py-4 text-lg font-medium rounded-full border-2 border-transparent bg-gradient-to-r from-blue-600 to-slate-700 text-white hover:from-blue-700 hover:to-slate-800 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl',
  secondaryButton: 'inline-flex items-center px-6 py-4 text-lg font-medium rounded-full border-2 border-slate-800 text-slate-800 dark:border-slate-400 dark:text-slate-100 hover:bg-slate-600 hover:text-white dark:hover:bg-slate-400 dark:hover:text-gray-900 transition-all duration-300'
} as const;
